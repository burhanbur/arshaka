...
@section('title', config('app.alias') . ' | Tambah Foto Armada')
    ...
    <div class="col-md-8 offset-md-2">
        <div class="kt-portlet">
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">
                        <i class="flaticon2-add-1"></i>&nbsp; Tambah Foto Armada
                    </h3>
                </div>
            ...
            <div class="kt-portlet__body">
                <form method="POST" action="{{ route('fleet.photo.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="fleet_category_id">
                            ...
                            @foreach($categories as $cat)
                                <option value="{{ $cat->id }}"
                                    {{ old('fleet_category_id', $selectedCatId) == $cat->id ? 'selected' : '' }}>
                                    {{ $cat->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="caption"
                               value="{{ old('caption') }}" placeholder="Keterangan foto (opsional)" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div id="imagePreview" class="mt-2" style="display:none;">
                            <img id="previewImg" src="" alt="Preview"
                                 style="max-height:220px;border-radius:6px;object-fit:cover;">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="text-muted">Angka lebih kecil tampil lebih dulu di carousel.</small>
